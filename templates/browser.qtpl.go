...
func StreamBrowser(qw422016 *qt422016.Writer, params string, page, totalPages int, imgs []common.CompactImage) {
	...
	qw422016.E().S(params)
	//line browser.qtpl:16
	qw422016.N().S(`" name="q" autofocus autocomplete="off"><script>var el = document.getElementById("search");el.selectionStart = el.selectionEnd = el.value.length;</script></form>`)
